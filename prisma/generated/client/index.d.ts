...
export namespace Prisma {
  ...
  */
  ...
  interface TodoFieldRefs {
    ...
    readonly time: FieldRef<"Todo", 'String'>
    readonly icon: FieldRef<"Todo", 'String'>
  ...
  export type TodoWhereInput = {
    ...
    time?: StringFilter<"Todo"> | string
    icon?: StringFilter<"Todo"> | string
  ...
  export type TodoScalarWhereWithAggregatesInput = {
    ...
    time?: StringWithAggregatesFilter<"Todo"> | string
    icon?: StringWithAggregatesFilter<"Todo"> | string
